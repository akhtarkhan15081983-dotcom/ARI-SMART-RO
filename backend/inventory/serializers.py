...
class EngineerBagIssueSerializer(
        ...
        if inventory_item.part.is_serialized:
            ...
            if not inventory_item.serial_number:
                ...
                raise serializers.ValidationError(
                    {
                        "inventory_item":
                            "Serialized part must have "
                            "a serial number."
                    }
                )

        # ----------------------------------------------------
        # SAME PHYSICAL ITEM CANNOT BE ISSUED TWICE
        # ----------------------------------------------------
...
class InventoryAuditLogSerializer(
    serializers.ModelSerializer
):
