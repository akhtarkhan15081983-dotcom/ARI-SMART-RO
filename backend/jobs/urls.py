...
urlpatterns = [
    ...
    path("jobs/<int:pk>/gps/", JobGPSUploadAPIView.as_view(), name="job-gps-upload"),
    path("jobs/<int:pk>/parts/", JobPartUsedAPIView.as_view(), name="job-parts-used"),
    path("jobs/<int:pk>/no-parts/", JobNoPartsDeclarationAPIView.as_view(), name="job-no-parts"),
    path("jobs/<int:pk>/signature/", JobSignatureUploadAPIView.as_view(), name="job-signature-upload"),
    path("", include(router.urls)),
    path("jobs/<int:pk>/", JobDetailAPIView.as_view(), name="job-detail"),
    path("jobs/<int:pk>/generate-otp/", GenerateOTPAPIView.as_view()),
