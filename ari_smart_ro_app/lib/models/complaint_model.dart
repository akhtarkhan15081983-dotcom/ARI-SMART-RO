class ComplaintModel {
  ...
  factory ComplaintModel.fromJson(Map<String, dynamic> json) {
    return ComplaintModel(
      ...
      linkedServiceIdDisplay: json['linked_service_id_display']?.toString() ?? '',
  ...
  String get displayEngineer {
    if (engineerName.isNotEmpty) return engineerName;
    if (engineerIdDisplay.isNotEmpty) return engineerIdDisplay;
    return 'Not Assigned';
  }

  String get displayComplaintType {
    switch (complaintType) {
      case 'RO_NOT_WORKING': return 'RO Not Working';
      case 'WATER_LEAKAGE': return 'Water Leakage';
      case 'LOW_TDS': return 'Low TDS';
      case 'BAD_TASTE': return 'Bad Taste';
      case 'LOW_WATER_FLOW': return 'Low Water Flow';
      case 'NO_WATER': return 'No Water';
      case 'PUMP_PROBLEM': return 'Pump Problem';
      case 'MEMBRANE_PROBLEM': return 'Membrane Problem';
      case 'FILTER_PROBLEM': return 'Filter Problem';
      case 'ELECTRICAL': return 'Electrical Problem';
      case 'NOISE': return 'Unusual Noise';
      case 'AMC_SERVICE': return 'AMC Service';
      case 'OTHER': return 'Other';
      default: return complaintType.isEmpty ? '-' : complaintType;
    }
  }
  ...
  String get displayPriority {
    switch (priority) {
      ...
      default: return priority.isEmpty ? '-' : priority;
    }
  }
