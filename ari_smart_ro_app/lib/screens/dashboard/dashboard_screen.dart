...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _handleItemTap(DashboardItem item) {
    switch (item.route) {
      case 'attendance':
        Navigator.of(context).push(MaterialPageRoute(builder: (_) => const AttendanceScreen())).then((_) => _loadAttendance());
        return;
      ...
      case 'map':
      case 'engineer_map': _push(const EngineerMapScreen()); return;
            ...
            children: [
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return DashboardCard(title: item.title, icon: item.icon, onTap: () => _handleItemTap(item));
                },
              ),
            ],
          ),
