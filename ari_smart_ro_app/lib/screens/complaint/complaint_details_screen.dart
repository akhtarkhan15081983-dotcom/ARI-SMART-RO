...
class _ComplaintDetailsScreenState
  ...
  void initState() {
    ...
    _complaintFuture =
        _complaintService.getComplaintDetail(
      widget.complaintId,
    );
  }
  ...
  Future<void> _startComplaint() async {
    await _runAction(() async {
      await _complaintService.startComplaint(
        widget.complaintId,
      );
  ...
  Future<void> _closeComplaint() async {
    ...
    await _runAction(() async {
      await _complaintService.closeComplaint(
        widget.complaintId,
      );
            ...
            TextField(
              ...
              decoration:
                ...
                labelText:
                    'Resolution *',
                hintText:
                    'Enter what was done to resolve the complaint.',
                border:
                    OutlineInputBorder(),
              ),
            ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Engineer: ${complaint.displayEngineer}',
            ),
          ],
        ),
      ),
