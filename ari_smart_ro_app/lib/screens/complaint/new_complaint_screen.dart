...
class NewComplaintScreen extends StatefulWidget {
  ...
  @override
  State<NewComplaintScreen> createState() =>
      _NewComplaintScreenState();
}

class _NewComplaintScreenState
    extends State<NewComplaintScreen> {
  // ============================================================
  // SERVICES
  // ============================================================
  ...
  final EngineerService _engineerService =
      EngineerService();
  ...
  final List<Map<String, String>>
      _complaintTypes = const [
    {
      "value": "RO_NOT_WORKING",
      "label": "RO Not Working",
    },
    {
      "value": "WATER_LEAKAGE",
      "label": "Water Leakage",
    ...
    {
      "value": "FILTER_PROBLEM",
      "label": "Filter Problem",
    },
    {
      "value": "MOTOR_PROBLEM",
      "label": "Motor / Pump Problem",
    },
    {
      "value": "OTHER",
      "label": "Other",
  ...
  Future<void> _initialize() async {
    ...
    debugPrint(
      "COMPLAINT SCREEN ROLE: $normalizedRole",
    );

    debugPrint(
      "COMPLAINT SCREEN CUSTOMER: $customerMode",
    );
