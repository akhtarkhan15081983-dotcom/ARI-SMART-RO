...
class _RentPaymentScreenState extends State<RentPaymentScreen> {
  ...
  void initState() {
    ...
    _futureRent = _rentService.getRentDetails();
  }
  ...
  void _openPaymentQr(double amount) {
    Navigator.of(
      context,
    ).push(MaterialPageRoute(builder: (_) => PaymentQrScreen(amount: amount)));
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Rent & Payment"), centerTitle: true),
      ...
      body: FutureBuilder<RentModel>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData) {
            return const Center(child: Text("No rent details found."));
          }
          ...
          return RefreshIndicator(
            ...
            child: ListView(
              ...
              children: [
                ...
                // CUSTOMER
                // ==================================================
                _CustomerCard(customer: rent.customer),
                ...
                // RENT HISTORY
                // ==================================================
                _HistoryCard(history: rent.history),
              ],
            ),
          );
        },
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _InfoRow(label: "Customer ID", value: customer.customerId),

            _InfoRow(label: "Card Number", value: customer.cardNumber),
            if (customer.oldCardNumber.trim().isNotEmpty)
              _InfoRow(label: "Old Card Number", value: customer.oldCardNumber),
          ],
        ),
      ),
    );
...
class _CurrentRentCard extends StatelessWidget {
  const _CurrentRentCard({required this.rent, required this.onPay});
  ...
  @override
  Widget build(BuildContext context) {
    final bool paid = rent.status.toUpperCase() == "PAID";
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _InfoRow(label: "Due Date", value: rent.formattedDueDate),
...
class _ROCard extends StatelessWidget {
  const _ROCard({required this.ro});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _InfoRow(label: "RO Model", value: ro.model),

            _MoneyRow(
              label: "Installation Charge",
              amount: ro.installationCharge,
            ),

            _MoneyRow(label: "Security Deposit", amount: ro.securityDeposit),

            _InfoRow(
              label: "Installation Date",
              value: ro.formattedInstallationDate,
            ),
          ],
        ),
      ),
